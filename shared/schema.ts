...
export const users = pgTable("users", {
  ...
  dashboardWidgets: text("dashboard_widgets")
    .array()
    .default(
      sql`ARRAY['revenue','listeners','content','alerts','trending','processing']::text[]`,
    ),
...
export const episodes = pgTable(
  ...
  (table) => [index("episodes_podcast_id_idx").on(table.podcastId)],
);
...
export const platformSettings = pgTable("platform_settings", {
  ...
  contentTypes: text("content_types")
    .array()
    .default(
      sql`ARRAY['video_clip','article','social_post','newsletter','seo_asset']::text[]`,
    ),
  defaultPlatforms: text("default_platforms")
    .array()
    .default(sql`ARRAY['TikTok','Reels','Shorts','X','LinkedIn']::text[]`),
...
export const subscriberPodcasts = pgTable(
  "subscriber_podcasts",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (table) => [
    index("subscriber_podcasts_composite_idx").on(
      table.subscriberId,
      table.podcastId,
    ),
  ],
...
export const companyContacts = pgTable(
  ...
  (table) => [index("company_contacts_company_id_idx").on(table.companyId)],
);
...
export const dealActivities = pgTable(
  ...
  (table) => [index("deal_activities_deal_id_idx").on(table.dealId)],
);
...
export const dealLineItems = pgTable(
  ...
  (table) => [index("deal_line_items_deal_id_idx").on(table.dealId)],
);
...
export const products = pgTable("products", {
  ...
  fulfillmentRequirements: jsonb("fulfillment_requirements").default(
    sql`'[]'::jsonb`,
  ),
...
export type OutboundCampaignAudience =
  (typeof OUTBOUND_CAMPAIGN_AUDIENCES)[number];
...
export type OutboundCampaignStatus =
  (typeof OUTBOUND_CAMPAIGN_STATUSES)[number];
...
export const newsletterSchedules = pgTable("newsletter_schedules", {
  ...
  contentTypes: text("content_types")
    .array()
    .default(sql`ARRAY['article','blog','social_post','newsletter']::text[]`),
...
export const newsletterRuns = pgTable("newsletter_runs", {
  ...
  body: text("body"),
  contentPieceIds: text("content_piece_ids")
    .array()
    .default(sql`ARRAY[]::text[]`),
  status: text("status").default("draft").notNull(),
...
export const newsLayoutSections = pgTable("news_layout_sections", {
  ...
  pinnedArticleIds: text("pinned_article_ids")
    .array()
    .default(sql`ARRAY[]::text[]`),
  displayOrder: integer("display_order").default(0).notNull(),
...
// Insert schemas
export const insertNewsLayoutSectionSchema = createInsertSchema(
  newsLayoutSections,
...
export const insertClipAssetSchema = createInsertSchema(clipAssets).omit({
  id: true,
  createdAt: true,
});
export const insertNewsletterScheduleSchema = createInsertSchema(
  newsletterSchedules,
).omit({ id: true, createdAt: true });
export const insertNewsletterRunSchema = createInsertSchema(
  newsletterRuns,
).omit({ id: true, createdAt: true });
...
export const insertOutboundCampaignSchema = createInsertSchema(
  outboundCampaigns,
...
export const insertSubscriberPodcastSchema = createInsertSchema(
  subscriberPodcasts,
...
export const insertDealLineItemSchema = createInsertSchema(dealLineItems).omit({
  id: true,
  createdAt: true,
});
export const insertCampaignEmailSchema = createInsertSchema(
  campaignEmails,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertTaskActivityLogSchema = createInsertSchema(
  taskActivityLogs,
).omit({ id: true, createdAt: true });
...
export type InsertSubscriberPodcast = z.infer<
  typeof insertSubscriberPodcastSchema
>;
...
export type InsertOutboundCampaign = z.infer<
  typeof insertOutboundCampaignSchema
>;
...
export type InsertNewsletterSchedule = z.infer<
  typeof insertNewsletterScheduleSchema
>;
...
export type InsertNewsLayoutSection = z.infer<
  typeof insertNewsLayoutSectionSchema
>;
...
export const insertReadLaterItemSchema = createInsertSchema(
  readLaterItems,
...
export const insertLegalTemplateSchema = createInsertSchema(
  legalTemplates,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export type InsertDeviceRegistration = z.infer<
  typeof insertDeviceRegistrationSchema
>;
...
export const insertPushNotificationSchema = createInsertSchema(
  pushNotifications,
).omit({ id: true, sentAt: true });
export type InsertPushNotification = z.infer<
  typeof insertPushNotificationSchema
>;
...
export const contentBookmarks = pgTable(
  ...
  (table) => [index("content_bookmarks_subscriber_idx").on(table.subscriberId)],
);

export const insertContentBookmarkSchema = createInsertSchema(
  contentBookmarks,
).omit({ id: true, bookmarkedAt: true });
...
export const pageRows = pgTable(
  ...
  (table) => [index("page_rows_page_id_idx").on(table.pageId)],
);

export const insertPageRowSchema = createInsertSchema(pageRows).omit({
  id: true,
  createdAt: true,
});
...
export const pageWidgets = pgTable(
  "page_widgets",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertPageWidgetSchema = createInsertSchema(pageWidgets).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCommunityEventSchema = createInsertSchema(
  communityEvents,
).omit({ id: true, createdAt: true });
...
export const insertCommunityPollSchema = createInsertSchema(
  communityPolls,
).omit({ id: true, createdAt: true });
...
export const pollVotes = pgTable(
  ...
  (table) => [
    uniqueIndex("poll_votes_poll_voter_idx").on(
      table.pollId,
...
export const insertCommunityAnnouncementSchema = createInsertSchema(
  communityAnnouncements,
).omit({ id: true, createdAt: true });
export type InsertCommunityAnnouncement = z.infer<
  typeof insertCommunityAnnouncementSchema
>;
...
export const insertBusinessListingSchema = createInsertSchema(
  businessListings,
).omit({ id: true, createdAt: true });
...
export const insertAiLayoutExampleSchema = createInsertSchema(
  aiLayoutExamples,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertAdInjectionLogSchema = createInsertSchema(
  adInjectionLog,
).omit({ id: true, injectedAt: true });
...
export const devicePushSubscriptions = pgTable(
  ...
  (table) => [index("device_push_subs_endpoint_idx").on(table.endpoint)],
);

export const insertDevicePushSubscriptionSchema = createInsertSchema(
  devicePushSubscriptions,
).omit({ id: true, createdAt: true, lastUsed: true });
export type InsertDevicePushSubscription = z.infer<
  typeof insertDevicePushSubscriptionSchema
>;
export type DevicePushSubscription =
  typeof devicePushSubscriptions.$inferSelect;

// ── Subscriber Bookmarks ──
export const subscriberBookmarks = pgTable(
  "subscriber_bookmarks",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (table) => [
    uniqueIndex("subscriber_bookmarks_email_article_idx").on(
...
export const insertSubscriberBookmarkSchema = createInsertSchema(
  subscriberBookmarks,
).omit({ id: true, savedAt: true });
export type InsertSubscriberBookmark = z.infer<
  typeof insertSubscriberBookmarkSchema
>;
...
export const insertCommunityPostSchema = createInsertSchema(
  communityPosts,
).omit({ id: true, createdAt: true, likesCount: true, replyCount: true });
...
export const communityLikes = pgTable(
  ...
  (table) => [
    uniqueIndex("community_likes_post_liker_idx").on(
      table.postId,
      table.likerIdentifier,
    ),
  ],
);

export const insertCommunityLikeSchema = createInsertSchema(
  communityLikes,
).omit({ id: true, createdAt: true });
...
export const insertAdminPageConfigSchema = createInsertSchema(
  adminPageConfigs,
).omit({ id: true });
...
export const insertAdminNavSectionSchema = createInsertSchema(
  adminNavSections,
).omit({ id: true });
...
export const insertAiInsightsCacheSchema = createInsertSchema(
  aiInsightsCache,
...
export const insertCommercialLeadSchema = createInsertSchema(
  commercialLeads,
).omit({ id: true, createdAt: true });
...
export const commercialProposals = pgTable(
  ...
  (table) => [index("commercial_proposals_lead_id_idx").on(table.leadId)],
);

export const insertCommercialProposalSchema = createInsertSchema(
  commercialProposals,
).omit({ id: true, createdAt: true });
export type InsertCommercialProposal = z.infer<
  typeof insertCommercialProposalSchema
>;
...
export const commercialOrders = pgTable(
  ...
  (table) => [index("commercial_orders_lead_id_idx").on(table.leadId)],
);

export const insertCommercialOrderSchema = createInsertSchema(
  commercialOrders,
).omit({ id: true, createdAt: true });
...
export const campaignPerformance = pgTable(
  ...
  (table) => [index("campaign_performance_order_id_idx").on(table.orderId)],
);
...
export const aiAdvertiserPrompts = pgTable(
  "ai_advertiser_prompts",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
...
export const insertAiAdvertiserPromptSchema = createInsertSchema(
  aiAdvertiserPrompts,
).omit({ id: true, createdAt: true });
export type InsertAiAdvertiserPrompt = z.infer<
  typeof insertAiAdvertiserPromptSchema
>;
...
export const insertAiContentLogSchema = createInsertSchema(aiContentLog).omit({
  id: true,
  generatedAt: true,
});
...
export const PUSH_CAMPAIGN_STATUSES = ["draft", "scheduled", "sending", "sent", "failed", "cancelled"] as const;
export type PushCampaignStatus = (typeof PUSH_CAMPAIGN_STATUSES)[number];
export const PUSH_SEGMENTS = ["all", "new", "engaged", "at_risk"] as const;

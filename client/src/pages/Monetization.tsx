...
const advertiserData = [
  { name: "MyPillow", spend: 45000, type: "Direct", status: "Active" },
  { name: "Black Rifle Coffee", spend: 32000, type: "Direct", status: "Active" },
  { name: "Patriot Mobile", spend: 28000, type: "Direct", status: "Active" },
  { name: "Hillsdale College", spend: 25000, type: "Sponsorship", status: "Active" },
  { name: "ExpressVPN", spend: 18000, type: "Programmatic", status: "Active" },
];
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="glass-panel border-border/50">
          <CardContent className="p-6">
            ...
            <div className="text-2xl font-bold font-display">$28.45</div>
        ...
        <Card className="glass-panel border-border/50">
          <CardContent className="p-6">
            ...
            <p className="text-xs text-muted-foreground mt-1">1.8% Unsold Inventory</p>
          </CardContent>
        </Card>
        <Card className="glass-panel border-border/50">
          <CardContent className="p-6">
      ...
      <Card className="glass-panel border-border/50">
        ...
        <CardContent>
          <div className="space-y-4">
            {advertiserData.map((ad, i) => (
              <div key={i} className="flex items-center justify-between p-4 bg-card/30 rounded border border-transparent hover:border-primary/20 transition-colors">
                ...
                <div className="flex items-center space-x-6">
                  <div className="text-right">
                    <p className="font-bold text-foreground">${ad.spend.toLocaleString()}</p>
                    <p className="text-xs text-muted-foreground">Monthly Spend</p>
                  </div>
                  <Badge variant="outline" className="bg-green-500/10 text-green-500 border-green-500/20 uppercase font-mono text-[10px]">
                    {ad.status}
                  </Badge>
                </div>
              </div>
